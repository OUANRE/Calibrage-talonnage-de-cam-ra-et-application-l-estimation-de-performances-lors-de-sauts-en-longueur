...
\section{Code de calibrage de la caméra}
 Notre code de calibrage sera éffectué en cinq (5) étapes principales et dans plusieurs fichiers différents.
  ...
  \subsection{Première étape : Capture d'image}
 	...
 	\begin{figure}[H]%
 		...
 		\fbox{
 			\includegraphics[scale=0.4]{images/captureimage1}
 		}
 	...
 	\begin{figure}[H]%
 		...
 		\setlength{\fboxrule}{0.5pt}%
 		\fbox{
 			\includegraphics[scale=0.4]{images/captureimage2}
 		}
 	...
 	\begin{figure}[H]%
 		...
 		\setlength{\fboxrule}{0.5pt}%
 		\fbox{
 			\includegraphics[scale=0.4]{images/captureimage3}
 		}
 	...
 	\begin{figure}[H]%
 		...
 		\setlength{\fboxrule}{0.5pt}%
 		\fbox{
 			\includegraphics[scale=0.7]{images/captureimage4}
 		}
 	...
 	\begin{figure}[H]%
 		...
 		\setlength{\fboxrule}{0.5pt}%
 		\fbox{
 			\includegraphics[scale=0.3]{images/interface}
 		}
 	...
 	Nous avons défini les coordonnées du monde réèl à l'aide du motif de damier de taille \textbf{(9,6)}. La taille se compte par l'intersection des carrés du damier horizontalement et verticalement.
 	 ...
 	 \begin{figure}[H]%
 	 	...
 	 	\setlength{\fboxrule}{0.5pt}%
 	 	\fbox{
 	 		\includegraphics[scale=0.3]{images/3d1}
 	 	}
 	 	...
 	 	\label{fig:Définition des coordonnées du monde réèl}
 	 	 ...
 	 	 \begin{figure}[H]%
 	 		...
 	 		\setlength{\fboxrule}{0.5pt}%
 	 		\fbox{
 	 			\includegraphics[scale=0.4]{images/3d2}
 	 		}
 	...
 	Pour ce faire, nous avons utilisé trois fonctions de \textbf{Opencv} à savoir \textbf{cv.findChessboardCorners()}, \textbf{cv.cornerSubPix} , \textbf{cv.drawChessboardCorners()} pour trouver, afiner et déssiner les coins du damier. Nous allons charger les images prise grâce au code de la première partie. 
 	 ...
 	 \begin{figure}[H]%
 		...
 		\setlength{\fboxrule}{0.5pt}%
 		\fbox{
 			\includegraphics[scale=0.4]{images/point1}
 		}
 	...
 	\begin{figure}[H]%
 		...
 		\setlength{\fboxrule}{0.5pt}%
 		\fbox{
 			\includegraphics[scale=0.4]{images/point2}
 		}
 ...
 \begin{figure}[H]%
 	...
 	\setlength{\fboxrule}{0.5pt}%
 	\fbox{
 		\includegraphics[scale=0.4]{images/calibrage}
 	}
...
\begin{figure}[H]%
	...
	\setlength{\fboxrule}{0.5pt}%
	\fbox{
		\includegraphics[scale=0.3]{images/calibrage2}
	}
...
\begin{figure}[H]%
	...
	\setlength{\fboxrule}{0.5pt}%
	\fbox{
		\includegraphics[scale=0.4]{images/resultat1}
	}
...
\begin{figure}[H]%
	...
	\setlength{\fboxrule}{0.5pt}%
	\fbox{
		\includegraphics[scale=0.4]{images/resultat2}
	}
...
\begin{figure}[H]%
	...
	\setlength{\fboxrule}{0.5pt}%
	\fbox{
		\includegraphics[scale=0.4]{images/distorsion1}
	}
...
\begin{figure}[H]%
	...
	\setlength{\fboxrule}{0.5pt}%
	\fbox{
		\includegraphics[scale=0.4]{images/distorsion2}
	}
...
\begin{figure}[H]%
	...
	\setlength{\fboxrule}{0.5pt}%
	\fbox{
		\includegraphics[scale=0.3]{images/resultat4}
	}
...
\begin{figure}[H]%
	...
	\setlength{\fboxrule}{0.5pt}%
	\fbox{
		\includegraphics[scale=0.4]{images/erreur}
	}
...
\subsection{Deuxième étape : Chargement des différents paramètres du calibrage }
 ...
 \begin{figure}[H]%
 	...
 	\setlength{\fboxrule}{0.5pt}%
 	\fbox{
 		\includegraphics[scale=0.4]{images/parametrecharge}
 	}
 ...
 \begin{figure}[H]%
 	...
 	\setlength{\fboxrule}{0.5pt}%
 	\fbox{
 		\includegraphics[scale=0.4]{images/captureimage6}
 	}
 ...
 \end{figure}
  ...
  \begin{figure}[H]%
 	...
 	\setlength{\fboxrule}{0.5pt}%
 	\fbox{
 		\includegraphics[scale=0.4]{images/captureimage5}
 	}
 ...
 \begin{figure}[H]%
 	...
 	\setlength{\fboxrule}{0.5pt}%
 	\fbox{
 		\includegraphics[scale=0.4]{images/distor}
 	}
